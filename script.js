...
tracks = [
  "./audiocopy/thatmaraudasong.mp4, ./audiocopycopy/bugbass.mp4"
];
thumbnails = [
  "./imgcopy/thatmaraudasong.jpg"
];
trackArtists = ["Marauda"];
trackTitles = ["thatmaraudasong"];
...
track.addEventListener("ended", pausePlay);
